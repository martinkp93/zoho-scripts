...
Revision Timestamp: 2026-03-19T16:03:22.676Z
Status: Functional
---
...
graph TD
    ...
    FindCust -- "Not Found" --> CreateCust["Create Customer (Billing)"]
    FindCust -- "Found" --> SubCreate["Create Subscription (Billing)"]
...
- **Customer Matching:** It searches Zoho Billing by email. If no match exists, it creates a new customer profile.
