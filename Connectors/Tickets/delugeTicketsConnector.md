...
Revision Timestamp: 2026-03-27T21:37:48.272Z
Status: Functional
---
...
> [!TIP]
> **Bug Fix:** The previous regression where the API Key creation action was misspelled as `createApiKe` has been resolved. The correct action string is now `createApiKey`.
...
- **2026-03-27T21:37:48.272Z:** Corrected typo in configuration map for API Key creation. Changed `createApiKe` back to the correct identifier `createApiKey`.